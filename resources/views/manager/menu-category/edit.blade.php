    ...
    <div class="row">
        <div class="col-md-12">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item"><a href="{{ url('manager/menu/categories') }}">Categories list</a></li>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('manager.menu.categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
