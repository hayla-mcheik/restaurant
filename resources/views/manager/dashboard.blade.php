    ...
    <div class="row">
       <div class="col-xl-3 col-md-6">
          <div class="card bg-primary text-white mb-4">
             <div class="card-body">Total Orders:<p class="text-white">
               <br/>
               @if($totalOrders)
                   {{ $totalOrders }}
               @else
       ...
       <div class="col-xl-3 col-md-6">
          <div class="card bg-warning text-white mb-4">
             <div class="card-body">Total Menu Categories:
               <p class="text-white">
                  <br/>
                  @if($totalMenuCategories)
                      {{ $totalMenuCategories }}
                  @else
       ...
       <div class="col-xl-3 col-md-6">
          <div class="card bg-success text-white mb-4">
             <div class="card-body">Total Menu Items:
               <p class="text-white">
                  <br/>
                  @if($menuItemCount)
                      {{ $menuItemCount }}
                   ...
                   @endswitch
                    ...
                    <td>
                     ...
                     <td>
                       ...
                       {{ $item->quantity }}<br>
                   @endforeach</td>
                     <td><a href="{{ route('manager.orders.status.edit', $order->id) }}" class="btn btn-sm btn-success"><i class="fas fa-eye"></i></a> </td>  
                  </tr>
           @empty
           <tr>
              <td>no orders</td>
